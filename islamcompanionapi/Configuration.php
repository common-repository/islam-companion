...
final class Configuration extends \Framework\Configuration\Configuration
{
    ...
    public function __construct($parameters) 
    {
        ...
        $this->user_configuration['general']['log_user_access'] = false;      
        ...
        $this->user_configuration['general']['development_mode'] =  true;
        ...
        if ($this->user_configuration['general']['development_mode']) 
        {
            ...
            $this->user_configuration['general']['api_server'] = "dev.pakjiddat.pk";
            /** The url of the development website for Islam Companion */
            $this->user_configuration['general']['website'] = "http://dev.pakjiddat.pk";
            /** The url for the Islam Companion http api */
            $this->user_configuration['general']['api_url'] = "http://dev.pakjiddat.pk/index.php";
            /** The base url of the audio files */
            $this->user_configuration['custom']['audio_file_base_url'] = "http://dev.pakjiddat.pk/islamcompanionapi/data/audio/";
            /** The site url for islam companion api */
            $this->user_configuration['general']['site_url'] = "http://dev.pakjiddat.pk/";            
        }
        /** If the application is in production mode */
        else 
        {
            /** The server name of the Islam Companion http api */
            $this->user_configuration['general']['api_server'] = "www.pakjiddat.pk";
            /** The url of the production website for Islam Companion */
            $this->user_configuration['general']['website'] = "http://www.pakjiddat.pk";
            /** The url for the Islam Companion http api */
            $this->user_configuration['general']['api_url'] = "http://www.pakjiddat.pk/index.php";
            /** The base url of the audio files */
            $this->user_configuration['custom']['audio_file_base_url'] = "http://gulbahao.org/data/";
            /** The site url for islam companion api */
            $this->user_configuration['general']['site_url'] = "http://www.pakjiddat.pk/";
            /** The font url list */
        ...
        else
        {
            ...
            $database_parameters = array(
                "host" => "localhost",
                "user" => "pakjidda_website",
                "password" => "q8xeGKraTiLmzIFpM1X9gt2l0uECHn",
                "database" => "pakjidda_website",
                "debug" => "1",
                "charset" => "utf8"
            );
            /** The framework database parameters */
     ...
     *
     * It returns true if the host name contains api.pakjiddat.pk and the url does not include '/admin/'
    ...
    final public static function IsValidRequest($module_name) 
    {
        ...
        /** If the host name contains api.pakjiddat.pk and the url does not include '/admin/' */
